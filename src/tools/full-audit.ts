...
export async function runComprehensiveSeoAudit(input: ComprehensiveAuditInput): Promise<ComprehensiveSeoReport> {
  ...
  let grade: ComprehensiveSeoReport['grade'] = 'F';
  if (overallSeoScore >= 95) grade = 'A+';
  else if (overallSeoScore >= 85) grade = 'A';
  else if (overallSeoScore >= 75) grade = 'B';
  else if (overallSeoScore >= 65) grade = 'C';
  else if (overallSeoScore >= 50) grade = 'D';
  ...
  const actionPlan: ComprehensiveSeoReport['prioritizedActionPlan'] = [];
